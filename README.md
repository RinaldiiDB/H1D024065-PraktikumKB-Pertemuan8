...
Proyek ini adalah implementasi Jaringan Saraf Tiruan Konvolusional (CNN) untuk mengklasifikasikan gambar tangan yang membentuk simbol **Batu (Rock)**, **Kertas (Paper)**, dan **Gunting (Scissors)**. Program ini dibangun menggunakan pustaka TensorFlow dan Keras.
